          ...
          {PRESETS.map((preset) => {
            ...
            return (
              ...
              >
                ...
                {isSelected && (
                  <Check size={12} className="absolute top-1 right-1 text-[#c9a96e]" />
                )}
              </button>
            );
          })}
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              onChange={(e) => handleCustomChange(e.target.value)}
              placeholder="#f5f0e8"
              className="flex-1 px-3 py-2 text-xs font-mono border border-[#e5e7eb] focus:border-[#c9a96e] focus:outline-none"
            />
          </div>
        </div>
      )}
