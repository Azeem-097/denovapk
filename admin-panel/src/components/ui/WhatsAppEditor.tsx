...
export function WhatsAppEditor({ value, onChange, variables }: WhatsAppEditorProps) {
  ...
  return (
    <div className="border border-[#e5e7eb] rounded-md bg-white overflow-hidden focus-within:border-[#c9a96e] focus-within:ring-1 focus-within:ring-[#c9a96e]/20 transition-all">
      {/* Toolbar */}
