        ...
        <div className="hidden md:flex flex-1 max-w-md mx-8">
          <div className="relative w-full">
            ...
            <input type="text" placeholder="Search orders, products, customers..."
              className="w-full pl-9 pr-4 py-2 text-sm bg-[#f8f9fa] border border-[#e5e7eb] focus:border-[#E10600] focus:outline-none placeholder:text-[#6b7280]/60" />
          </div>
        </div>

        <div className="flex items-center gap-1.5 sm:gap-2">
          <a href="http://localhost:3000" target="_blank" rel="noopener noreferrer"
            className="hidden sm:flex items-center gap-1.5 text-xs font-medium text-[#6b7280] hover:text-[#E10600] border border-[#e5e7eb] px-3 py-2 transition-colors">
