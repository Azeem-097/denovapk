  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-start justify-between flex-wrap gap-3">
        <div>
          <h1 className="text-2xl font-bold text-[#1a1a1a] flex items-center gap-2">
            <Award size={22} className="text-[#E10600]" />
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        <StatCard icon={Award}       label="Outstanding Points" value={stats.totalOutstanding.toLocaleString()} color="text-[#E10600]" />
      ...
      <div className="bg-white border border-[#e5e7eb] p-3">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 text-sm border border-[#e5e7eb] focus:border-[#E10600] focus:outline-none"
          />
        </div>
      </div>
      ...
      <div className="bg-white border border-[#e5e7eb] overflow-hidden">
        {filtered.length === 0 ? (
          <div className="p-12 text-center">
            <Award size={40} className="text-[#E10600] mx-auto mb-3" />
              ...
              <tbody className="divide-y divide-[#e5e7eb]">
                {filtered.map((c) => (
                  <tr key={c.id} className="hover:bg-[#fafaf9] transition-colors">
                    ...
                    <td className="px-4 py-3">
                      <span className="text-lg font-bold text-[#E10600]">{c.loyaltyPoints}</span>
