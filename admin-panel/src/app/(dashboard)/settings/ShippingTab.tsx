    ...
    <div>
      ...
      <div className="flex">
        ...
        <input
          ...
          disabled={disabled}
          className="flex-1 w-full px-3 py-2.5 text-sm border border-[#e5e7eb] focus:border-[#E10600] focus:outline-none disabled:bg-[#fafaf9] disabled:text-[#9ca3af] disabled:cursor-not-allowed"
        />
      </div>
    ...
    <div>
      ...
      <div className="space-y-4">
        ...
        <label className={`flex items-center gap-3 p-4 border cursor-pointer transition-colors ${
          freeDelivery ? "border-[#E10600] bg-[#f5f0e8]/40" : "border-[#e5e7eb] bg-[#fafaf9]"
        }`}>
          ...
          {freeDelivery && (
            <span className="text-[10px] font-bold uppercase tracking-wider bg-[#E10600] text-white px-2 py-1">
              Active
            </span>
          )}
        </label>
        ...
        <div className="pt-4 border-t border-[#e5e7eb]">
          <h3 className="text-xs font-bold uppercase tracking-wide text-[#E10600] mb-3">
            COD Handling Fee
          </h3>
        ...
        <div className="pt-4 border-t border-[#e5e7eb]">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-xs font-bold uppercase tracking-wide text-[#E10600]">Customer Preview</h3>
          </div>
