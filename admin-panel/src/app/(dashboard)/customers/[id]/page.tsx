      ...
      <div className="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-5">
        <div className="space-y-5">
          <div className="bg-white border border-[#e5e7eb] p-6 text-center">
            <div className="w-20 h-20 mx-auto rounded-full bg-[#f5f0e8] flex items-center justify-center mb-4">
              <span className="text-2xl font-bold text-[#c9a96e]">{getInitials(customer.name)}</span>
            </div>
          ...
          {isVIP && (
            <div className="bg-[#f5f0e8] border border-[#c9a96e]/30 p-4">
              <div className="flex items-center gap-2 mb-2">
                <Star size={14} className="text-[#c9a96e]" fill="currentColor" />
        ...
        <div className="space-y-5">
          <div className="grid grid-cols-3 gap-3">
            ...
            <StatBox icon={TrendingUp}  label="Total Spent"  value={formatPrice(customer.totalSpent)} color="text-[#c9a96e]" />
                    ...
                    <div className="flex items-center justify-between gap-3 flex-wrap">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 flex-wrap">
                          <span className="text-sm font-bold text-[#c9a96e]">#{order.orderNumber}</span>
...
function ContactRow({ icon: Icon, label, href }: {
  ...
  return href ? <a href={href} className="hover:text-[#c9a96e]">{content}</a> : content;
}
