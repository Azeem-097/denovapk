...
|---------|-------|------|--------|
| User Panel (src/) | 170 | 813.2 KB | 1_user-panel.txt |
| Admin Panel (src/) | 125 | 733.9 KB | 2_admin-panel.txt |
| Database Files | 39 | 244.5 KB | 3_database.txt |
| Configuration Files | 16 | 12.7 KB | 4_configs.txt |
