        ...
        <FadeIn>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="border border-[#e5e7eb] bg-white p-5 text-center">
              <Package size={22} className="text-[#c9a96e] mx-auto mb-2" strokeWidth={1.75} />
            ...
            <div className="border border-[#e5e7eb] bg-white p-5 text-center">
              <RotateCcw size={22} className="text-[#c9a96e] mx-auto mb-2" strokeWidth={1.75} />
            ...
            <div className="border border-[#e5e7eb] bg-white p-5 text-center">
              <Shield size={22} className="text-[#c9a96e] mx-auto mb-2" strokeWidth={1.75} />
          ...
          <div className="bg-[#f5f0e8] border border-[#c9a96e]/30 p-6 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-[#6b7280] mb-3">
                Reach us at{" "}
                <a href={`mailto:${info.email}`} className="text-[#c9a96e] hover:underline">
                  {info.email}
                </a>{" "}
                or{" "}
                <a href={`tel:${info.phone}`} className="text-[#c9a96e] hover:underline">
                  {info.phone}
                </a>
                .
              </p>
