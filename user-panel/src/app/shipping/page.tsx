  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-14 space-y-12">
            ...
            <div className="border border-[#e5e7eb] bg-white p-6 sm:p-8">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
                ...
                <div className="w-14 h-14 rounded-full bg-[#f5f0e8] flex items-center justify-center flex-shrink-0">
                  <Truck size={22} className="text-[#F97316]" strokeWidth={1.75} />
                </div>
        ...
        {!freeDeliveryAll && threshold > 0 && (
          <FadeIn>
            <div className="bg-[#1a1a1a] text-white p-6 sm:p-8 flex items-center gap-4">
              <Package size={32} className="text-[#F97316] flex-shrink-0" />
              <div>
        ...
        <FadeIn>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="border border-[#e5e7eb] bg-white p-5 text-center">
              <Package size={22} className="text-[#F97316] mx-auto mb-2" strokeWidth={1.75} />
            ...
            <div className="border border-[#e5e7eb] bg-white p-5 text-center">
              <RotateCcw size={22} className="text-[#F97316] mx-auto mb-2" strokeWidth={1.75} />
            ...
            <div className="border border-[#e5e7eb] bg-white p-5 text-center">
              <Shield size={22} className="text-[#F97316] mx-auto mb-2" strokeWidth={1.75} />
        ...
        <FadeIn>
          <div className="bg-[#f5f0e8] border border-[#F97316]/30 p-6 flex items-start gap-4">
            <Phone size={18} className="text-[#F97316] flex-shrink-0 mt-0.5" />
            <div>
              ...
              <p className="text-xs text-[#6b7280] mb-3">
                Reach us at{" "}
                <a href={`mailto:${info.email}`} className="text-[#F97316] hover:underline">
                  {info.email}
                </a>{" "}
                or{" "}
                <a href={`tel:${info.phone}`} className="text-[#F97316] hover:underline">
                  {info.phone}
                </a>
                .
              </p>
              <Link
                href="/contact"
                className="text-xs font-semibold text-[#F97316] hover:text-[#C2410C] underline"
              >
                Contact Support
              </Link>
            </div>
