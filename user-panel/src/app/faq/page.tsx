        ...
        <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr] gap-8 lg:gap-12">
          ...
          <aside className="lg:sticky lg:top-24 lg:self-start">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    activeCategory === cat.category
                      ? "border-[#3b5f8f] text-[#3b5f8f] bg-[#f5f0e8]"
            ...
            <div className="mt-8 bg-[#1a1a1a] text-white p-5">
              <p className="text-xs font-semibold tracking-[0.15em] uppercase text-[#3b5f8f] mb-2">
                Still Need Help?
              </p>
              ...
              <Link
                href="/contact"
                className="block text-center bg-[#3b5f8f] text-white text-xs font-semibold tracking-wide uppercase py-2.5 hover:bg-[#2d4a72] transition-colors"
              >
                Contact Us
              </Link>
            </div>
  ...
  return (
    <div
      className={cn(
        ...
        open ? "border-[#3b5f8f]" : "border-[#e5e7eb]"
      )}
    >
      <button
