        ...
        <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr] gap-8 lg:gap-12">
          ...
          <aside className="lg:sticky lg:top-24 lg:self-start">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    activeCategory === cat.category
                      ? "border-[#c9a96e] text-[#c9a96e] bg-[#f5f0e8]"
            ...
            <div className="mt-8 bg-[#1a1a1a] text-white p-5">
              <p className="text-xs font-semibold tracking-[0.15em] uppercase text-[#c9a96e] mb-2">
                Still Need Help?
              </p>
              ...
              <Link
                href="/contact"
                className="block text-center bg-[#c9a96e] text-white text-xs font-semibold tracking-wide uppercase py-2.5 hover:bg-[#b8955a] transition-colors"
              >
                Contact Us
              </Link>
            </div>
  ...
  return (
    <div
      className={cn(
        ...
        open ? "border-[#c9a96e]" : "border-[#e5e7eb]"
      )}
    >
      <button
