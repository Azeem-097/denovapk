        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn>
            <Breadcrumb
              ...
              className="mb-6 [&_span]:text-white/60 [&_a]:text-white/60 [&_a:hover]:text-[#F97316] [&_svg]:text-white/40"
            />
          </FadeIn>
          <FadeIn>
          ...
          <TextReveal as="h1" delay={100}>
            <span className="font-[family-name:var(--font-playfair)] text-3xl sm:text-4xl lg:text-5xl font-bold text-white mt-2 block leading-tight">
              Build the Future of
              <br />
              <span className="text-[#F97316]">Pakistani Fashion</span>
            </span>
          </TextReveal>
          <FadeIn delay={200}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
            {PERKS.map((perk, i) => (
              <SlideUp key={perk.title} stagger={80} index={i}>
                <div className="group border border-[#e5e7eb] bg-white p-6 hover:border-[#F97316] transition-colors">
                  <div className="w-10 h-10 rounded-full bg-[#f5f0e8] flex items-center justify-center mb-4 group-hover:bg-[#F97316] transition-colors">
                    <perk.icon size={18} className="text-[#F97316] group-hover:text-white transition-colors" />
                  </div>
          ...
          <div className="space-y-4">
            {OPENINGS.map((job, i) => (
              <FadeIn key={job.title} delay={i * 50}>
                <div className="bg-white border border-[#e5e7eb] p-5 sm:p-6 hover:border-[#F97316] transition-colors group">
                  <div className="flex items-start justify-between gap-3 flex-wrap">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 flex-wrap mb-2">
                        <h3 className="text-base font-bold text-[#1a1a1a]">{job.title}</h3>
                        <span className="text-[10px] px-2 py-0.5 bg-[#f5f0e8] text-[#F97316] font-semibold uppercase tracking-wider">
                          {job.department}
                        </span>
                      </div>
                    ...
                    <Link
                      ...
                      className="group/btn inline-flex items-center gap-2 bg-[#1a1a1a] text-white px-5 py-2.5 text-xs font-semibold tracking-wide hover:bg-[#F97316] transition-colors flex-shrink-0 mt-1"
                    >
                      Apply Now
        ...
        <FadeIn>
          <div className="bg-[#fafaf9] border border-[#e5e7eb] p-8 text-center">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#1a1a1a] text-white px-7 py-3 text-sm font-semibold hover:bg-[#F97316] transition-colors"
            >
