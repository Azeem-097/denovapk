  ...
  return (
    <div className="min-h-screen pt-24 flex items-center justify-center bg-[#fafaf9]">
      <div className="text-center px-4">
        <p className="font-[family-name:var(--font-cormorant)] text-8xl sm:text-9xl font-light text-[#c9a96e] leading-none mb-4">
          404
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            href="/"
            className="inline-flex items-center justify-center bg-[#1a1a1a] text-white px-7 py-3 text-sm font-semibold tracking-wide hover:bg-[#c9a96e] transition-colors duration-300"
          >
            Back to Home
          </Link>
          <Link
