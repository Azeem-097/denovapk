          ...
          <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
            <FadeIn>
              <Breadcrumb
                ...
                className="mb-4 [&_span]:text-white/70 [&_a]:text-white/70 [&_a:hover]:text-[#c9a96e] [&_svg]:text-white/50"
              />
            </FadeIn>
            <FadeIn delay={100}>
            ...
            {STATS.map((stat, i) => (
              <SlideUp key={stat.label} stagger={100} index={i}>
                <div className="text-center">
                  <p className="font-[family-name:var(--font-playfair)] text-4xl sm:text-5xl lg:text-6xl font-bold text-[#c9a96e] leading-none">
                    {stat.number}
                  </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 lg:gap-8">
            {VALUES.map((val, i) => (
              <SlideUp key={val.title} stagger={100} index={i}>
                <div className="group border border-[#e5e7eb] p-6 lg:p-8 hover:border-[#c9a96e] transition-colors bg-white">
                  <div className="w-11 h-11 rounded-full bg-[#f5f0e8] flex items-center justify-center mb-4 group-hover:bg-[#c9a96e] transition-colors">
                    <val.icon size={20} className="text-[#c9a96e] group-hover:text-white transition-colors" />
                  </div>
            ...
            {TEAM.map((member, i) => (
              <SlideUp key={member.name} stagger={80} index={i}>
                <div className="group">
                  ...
                  <p className="text-xs text-[#c9a96e] tracking-wide mt-0.5">
                    {member.role}
                  </p>
                </div>
              </SlideUp>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <FadeIn delay={300}>
            <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
              <Link
                href="/shop"
                className="group inline-flex items-center justify-center gap-2 bg-[#1a1a1a] text-white px-8 py-3.5 text-sm font-semibold tracking-wide hover:bg-[#c9a96e] transition-colors"
              >
                Shop Collections
