      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-10">
              ...
              <div className="group relative">
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <button
                      ...
                      className="w-full bg-[#1a1a1a] text-white text-xs font-semibold tracking-wider uppercase py-3 hover:bg-[#F97316] transition-colors duration-200 inline-flex items-center justify-center gap-1.5"
                    >
                      <ShoppingBag size={13} />
                      View Product
                    </button>
                ...
                <div className="px-0.5">
                  <Link href={`/products/${item.slug}`}>
                    <h3 className="text-sm font-medium text-[#1a1a1a] hover:text-[#F97316] transition-colors leading-snug mb-1.5 line-clamp-1">
                      {item.name}
                    </h3>
                  </Link>
        ...
        <FadeIn delay={300}>
          <div className="text-center mt-12">
            <Link
              href="/shop"
              className="group inline-flex items-center gap-2 text-sm font-semibold tracking-wide text-[#1a1a1a] hover:text-[#F97316] transition-colors"
            >
              Continue Shopping
              <ArrowRight
                size={16}
    ...
    <div className="pt-32 pb-20 min-h-screen bg-[#fafaf9]">
      <div className="max-w-md mx-auto px-4 text-center">
        <div className="w-24 h-24 mx-auto bg-white border border-[#e5e7eb] rounded-full flex items-center justify-center mb-6">
          <Heart size={36} className="text-[#F97316]" />
        </div>
        ...
        <Link
          href="/shop"
          className="inline-flex items-center gap-2 bg-[#1a1a1a] text-white px-8 py-3.5 text-sm font-semibold tracking-wide hover:bg-[#F97316] transition-colors duration-300"
        >
          Explore Collections
          <ArrowRight size={16} />
        </Link>
