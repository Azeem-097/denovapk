  ...
  return (
    <>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-14 space-y-12">
        ...
        {/* How to Measure Tips */}
        <FadeIn>
          <div className="bg-[#f5f0e8] border border-[#F97316]/30 p-6 lg:p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {TIPS.map((tip) => (
                <div key={tip.title} className="bg-white p-4 border border-[#e5e7eb]">
                  <p className="text-xs font-bold text-[#F97316] uppercase tracking-wider mb-1">{tip.title}</p>
        ...
        <FadeIn>
          <div className="border border-[#e5e7eb] bg-white p-5 text-center">
            <p className="text-sm text-[#6b7280]">
              ...
              <a href="https://wa.me/923001234567" target="_blank" rel="noopener noreferrer" className="text-[#F97316] font-semibold hover:underline">
                WhatsApp us
              </a>{" "}
