  ...
  return (
    <div className="bg-white border border-[#e5e7eb] p-5 lg:p-6">
      <div className="flex items-center gap-2 mb-5">
        <User size={16} className="text-[#E10600]" />
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 bg-[#1a1a1a] text-white px-5 py-2.5 text-xs font-semibold uppercase tracking-wide hover:bg-[#E10600] transition-colors disabled:opacity-60"
        >
          <Save size={13} />
...
function PasswordForm({ onSave }: { onSave: () => void }) {
  ...
  return (
    <div className="bg-white border border-[#e5e7eb] p-5 lg:p-6">
      <div className="flex items-center gap-2 mb-5">
        <Lock size={16} className="text-[#E10600]" />
        <h2 className="text-sm font-semibold tracking-[0.15em] uppercase text-[#1a1a1a]">
          Change Password
        </h2>
      </div>
...
function NotificationsSection({ showToast }: {
  ...
  return (
    <div className="bg-white border border-[#e5e7eb] p-5 lg:p-6">
      <div className="flex items-center gap-2 mb-5">
        <Bell size={16} className="text-[#E10600]" />
        <h2 className="text-sm font-semibold tracking-[0.15em] uppercase text-[#1a1a1a]">
          Email Notifications
        </h2>
      </div>
          ...
          >
            ...
            <button
              ...
              className={`relative w-10 h-5 rounded-full transition-colors flex-shrink-0 mt-1 ${
                prefs[item.key as keyof typeof prefs] ? "bg-[#E10600]" : "bg-[#e5e7eb]"
              }`}
            >
              <div
