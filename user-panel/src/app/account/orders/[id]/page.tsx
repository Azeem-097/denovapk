    ...
    return (
      <div className="pt-32 pb-20 min-h-screen bg-[#fafaf9]">
        <div className="max-w-md mx-auto px-4 text-center">
          <Package size={48} className="text-[#F97316] mx-auto mb-4" />
    ...
    <>
      <div className="pt-28 pb-6 sm:pt-32 sm:pb-8 bg-[#fafaf9] border-b border-[#e5e7eb]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <FadeIn>
            <Link href="/account/orders" className="inline-flex items-center gap-1.5 text-xs text-[#6b7280] hover:text-[#F97316] mb-2">
              <ArrowLeft size={13} />
              Back to orders
            </Link>
          </FadeIn>
          ...
          <div className="space-y-6">
                ...
                <div className="bg-white border border-[#e5e7eb] p-5 lg:p-6">
                  ...
                  <div className="relative">
                    <div className="absolute top-4 left-0 right-0 h-0.5 bg-[#e5e7eb] mx-4">
                      <div className="h-full bg-[#F97316] transition-all duration-700"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <FadeIn delay={250}>
                <div className="bg-white border border-[#e5e7eb] p-5">
                  <div className="flex items-center gap-2 mb-3">
                    <CreditCard size={14} className="text-[#F97316]" />
            ...
            <FadeIn delay={400}>
              <div className="bg-[#f5f0e8] border border-[#F97316]/30 p-5 lg:p-6 flex items-start gap-4">
                <MessageCircle size={20} className="text-[#F97316] flex-shrink-0 mt-0.5" />
                ...
                <Link href="/contact" className="text-xs font-semibold text-[#F97316] hover:text-[#C2410C] underline whitespace-nowrap">
                  Contact Us
                </Link>
              </div>
            </FadeIn>
...
function SumRow({ label, value, highlight }: { label: string; value: string; highlight?: boolean }) {
  return (
    <div className="flex items-center justify-between">
      ...
      <span className={`font-medium ${highlight ? "text-[#F97316]" : "text-[#1a1a1a]"}`}>{value}</span>
    </div>
  );
}
