        ...
        <div className="grid grid-cols-1 lg:grid-cols-[260px_1fr] gap-6 lg:gap-8">
          ...
          <div>
            ...
            <div className="bg-white border border-[#e5e7eb] p-4 mb-6 flex items-center justify-between gap-3 flex-wrap">
              <div className="relative flex-1 min-w-[200px]">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2.5 text-sm border border-[#e5e7eb] focus:border-[#F97316] focus:outline-none placeholder:text-[#6b7280]/60"
                />
              </div>
            ...
            {loading ? (
              ...
              <div className="bg-white border border-[#e5e7eb] p-10 text-center">
                <ShoppingBag size={40} className="text-[#F97316] mx-auto mb-4" />
                ...
                {filteredOrders.map((order, i) => (
                  <FadeIn key={order.id} delay={i * 60}>
                    <Link
                      ...
                      className="block bg-white border border-[#e5e7eb] hover:border-[#F97316] transition-colors"
                    >
                      ...
                      <div className="px-5 py-4 flex items-center gap-4 flex-wrap">
                        ...
                        <ArrowRight size={16} className="text-[#F97316] flex-shrink-0" />
                      </div>
                    </Link>
                  </FadeIn>
                ))}
