    ...
    <div className="min-h-screen bg-[#fafaf9] pt-24 pb-16 sm:pt-28 sm:pb-20">
      <div className="max-w-md mx-auto px-4 sm:px-6">
        ...
        <FadeIn>
          <Link
            href="/account/login"
            className="inline-flex items-center gap-1.5 text-xs text-[#6b7280] hover:text-[#F97316] transition-colors mb-8"
          >
            <ArrowLeft size={13} />
            Back to login
          </Link>
            ...
            <FadeIn delay={200}>
              <div className="bg-white border border-[#e5e7eb] p-6 sm:p-8">
                ...
                <p className="mt-6 text-center text-sm text-[#6b7280]">
                  ...
                  <Link href="/account/login" className="text-[#F97316] font-semibold hover:underline">
                    Sign in
                  </Link>
                </p>
              </div>
