        ...
        <div className="grid grid-cols-1 lg:grid-cols-[260px_1fr] gap-6 lg:gap-8">
          ...
          <div className="space-y-6">
            {loading ? (
              ...
              <div className="bg-[#f5f0e8] border border-[#F97316]/30 p-8 text-center">
                <Gift size={40} className="text-[#F97316] mx-auto mb-3" />
                ...
                <FadeIn>
                  <div className="bg-gradient-to-br from-[#1a1a1a] to-[#333333] text-white p-6 sm:p-8 relative overflow-hidden">
                    ...
                    <div className="relative">
                      <p className="text-xs uppercase tracking-[0.2em] text-[#F97316] mb-2">
                      ...
                      <p className="text-lg text-[#F97316] font-semibold mt-3">
                  ...
                  <div className="bg-white border border-[#e5e7eb]">
                    ...
                    {data.history.length === 0 ? (
                      <div className="p-10 text-center">
                        <Award size={32} className="text-[#F97316] mx-auto mb-3" />
...
function StepCard({ num, title, desc }: { num: string; title: string; desc: string }) {
  return (
    <div className="flex items-start gap-3">
      <div className="w-9 h-9 rounded-full bg-[#F97316] text-white flex items-center justify-center flex-shrink-0 font-bold">
        {num}
      </div>
      <div>
