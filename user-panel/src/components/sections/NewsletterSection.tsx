    ...
    >
      ...
      <div className="lg:hidden">
        ...
        <div className="site-container flex justify-center pt-6 sm:pt-8">
          <Link
            href="/shop"
            className="shimmer-btn hover-lift inline-flex items-center gap-2 bg-[#1a1a1a] text-white px-10 py-4 text-xs font-semibold tracking-[0.2em] uppercase hover:bg-[#F97316] transition-all duration-300 shadow-md"
          >
            Shop Now
            <ArrowRight size={14} />
          </Link>
      ...
      <div className="hidden lg:block relative">
        ...
        <div
          className="absolute top-[8%] left-[4%] w-40 h-40 rounded-full bg-[#F97316]/8 animate-float-soft pointer-events-none"
          style={{ animationDuration: "8s" }}
        />
        <div
          className="absolute bottom-[10%] left-[8%] w-32 h-32 rounded-full bg-[#F97316]/6 animate-float-soft pointer-events-none"
...
function CommunityContent({ config, align }: CommunityContentProps) {
  ...
  return (
    <div className={`flex flex-col ${flexAlign} ${textAlign}`}>
      ...
      <FadeIn>
        <span className="inline-flex items-center gap-2 text-[10px] sm:text-xs font-semibold tracking-[0.28em] uppercase text-[#F97316]">
      ...
      <TextReveal as="h2" delay={100}>
        ...
        >
          Dress the Part.
          <br />
          <span className="text-[#F97316] italic font-normal">Live the Legacy.</span>
        </span>
      </TextReveal>
      ...
      <ScaleIn from={0.95} delay={350}>
        <div className={`mt-7 flex flex-wrap items-center gap-x-6 gap-y-3 ${isLeft ? "" : "justify-center"}`}>
          {hasLink ? (
            ...
            <Link
              href="/shop"
              className="shimmer-btn hover-lift group inline-flex items-center gap-2 bg-[#1a1a1a] text-white px-7 py-3.5 text-sm font-semibold tracking-wide hover:bg-[#F97316] transition-all duration-300 shadow-sm"
            >
      ...
      <FadeIn delay={480}>
        <p className={`mt-5 text-[11px] text-[#6b7280]/80 tracking-wide ${isLeft ? "" : "text-center"}`}>
          ...
          <a href="/privacy" className="underline decoration-dotted underline-offset-2 hover:text-[#F97316] transition-colors">
            privacy policy
          </a>.
        </p>
      </FadeIn>
