 ...
 *
 *   Desktop: IMAGE dictates section height (no min-height forced).
 *            Full uncropped image with shoes visible.
 *            Content sits absolutely-positioned on the left cream area.
 *
 *   Mobile:  Dedicated mobile image (different framing).
 *            Image stacks on top, content flows below.
 */
