...
export function SaleCountdown() {
  ...
  return (
    <section className="relative w-full bg-white py-10 sm:py-12 lg:py-14 overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-24 h-px bg-gradient-to-r from-transparent via-[#F97316]/40 to-transparent" />
          ...
          <div className="text-center lg:text-left">
            ...
            <FadeIn delay={200}>
              <Link
                ...
                className="group inline-flex items-center gap-2 mt-4 sm:mt-5 text-xs sm:text-sm font-semibold tracking-[0.2em] uppercase text-[#1a1a1a] border-b border-[#1a1a1a] pb-0.5 hover:text-[#F97316] hover:border-[#F97316] transition-all duration-300"
              >
                Shop The Sale
                <svg
                  width="14"
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-24 h-px bg-gradient-to-r from-transparent via-[#F97316]/40 to-transparent" />
      ...
      <div className="relative overflow-hidden">
        <span
          className={cn(
            ...
            pulseOnTick && mounted && "text-[#F97316]"
          )}
...
function CountdownSeparator() {
  return (
    <span
      className="font-[family-name:var(--font-playfair)] text-2xl sm:text-3xl lg:text-4xl font-light text-[#F97316]/40 leading-none mt-1 sm:mt-1.5 lg:mt-2 hidden sm:block"
      aria-hidden="true"
    >
      :
    </span>
