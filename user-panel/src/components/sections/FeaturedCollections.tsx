      ...
      <div className="site-container">
        <FadeIn delay={500}>
          <div className="text-center mt-10 sm:mt-14 lg:mt-16">
            <Link
              href="/shop"
              className="group relative inline-flex items-center gap-2 text-xs sm:text-sm font-semibold tracking-[0.2em] uppercase text-[#1a1a1a] hover:text-[#3b5f8f] transition-colors duration-200 whitespace-nowrap pb-1"
            >
              ...
              />
              {/* Animated underline */}
              <span className="absolute left-0 right-0 bottom-0 h-px bg-[#3b5f8f] scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-400" />
            </Link>
          </div>
        </FadeIn>
      </div>
      ...
      <div className="absolute inset-0 flex items-center justify-center px-6">
        <div className="relative">
          ...
          <div className="mt-3 flex justify-center">
            <span
              className="block h-[2px] w-[60px] bg-[#3b5f8f] scale-x-0 group-hover:scale-x-100 origin-center transition-transform duration-700"
            />
          </div>
        </div>
      </div>
