        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-10 lg:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-2">
            <Link href="/" className="inline-flex flex-col leading-none mb-5">
              ...
              <span className="text-[9px] font-medium tracking-[0.35em] text-[#c9a96e] uppercase -mt-0.5">
                Pakistan
              </span>
            </Link>

            <p className="text-sm text-white/60 leading-relaxed max-w-xs mb-6">
              Premium clothing crafted for the modern Pakistani. Every piece tells a story of quality, elegance, and timeless style.
            </p>
            ...
            <div className="flex flex-col gap-3 mb-6">
              <a
                ...
                className="flex items-center gap-2.5 text-sm text-white/60 hover:text-[#c9a96e] transition-colors"
              >
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-9 h-9 flex items-center justify-center rounded-full border border-white/20 text-white/60 hover:border-[#c9a96e] hover:text-[#c9a96e] transition-all duration-200"
                >
                  {social.icon}
                </a>
              ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
            <p className="text-xs text-white/40 text-center sm:text-left">
              © {year} Denova PK. All rights reserved.
            </p>
            ...
            <p className="text-xs text-white/30">
              JazzCash · EasyPaisa · COD · Bank Transfer
            </p>
          </div>
        </div>
      </div>
