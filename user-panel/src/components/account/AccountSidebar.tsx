        ...
        <div className="flex items-center gap-3">
          <div className="w-11 h-11 rounded-full bg-[#f5f0e8] flex items-center justify-center flex-shrink-0">
            {user?.avatar ? (
              ...
              <span className="text-sm font-bold text-[#E10600]">{initials}</span>
            )}
          </div>
          ...
          return (
            <Link key={item.href} href={item.href}
              className={cn(
                ...
                active ? "bg-[#f5f0e8] text-[#E10600] font-semibold" : "text-[#1a1a1a] hover:bg-[#fafaf9]"
              )}>
              <Icon size={16} className={active ? "text-[#E10600]" : "text-[#6b7280]"} />
    ...
    <div className="pt-32 pb-20 min-h-screen bg-[#fafaf9]">
      <div className="max-w-md mx-auto px-4 text-center">
        <div className="w-24 h-24 mx-auto bg-white border border-[#e5e7eb] rounded-full flex items-center justify-center mb-6">
          <User size={36} className="text-[#E10600]" />
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link href="/account/login" className="inline-flex items-center justify-center gap-2 bg-[#1a1a1a] text-white px-7 py-3.5 text-sm font-semibold tracking-wide hover:bg-[#E10600] transition-colors">
            Sign In
          </Link>
