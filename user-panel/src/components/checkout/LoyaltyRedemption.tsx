...
export function LoyaltyRedemption({ subtotal, onRedeem, currentPoints }: Props) {
  ...
  if (data.points === 0) {
    return (
      <div className="border border-[#e5e7eb] bg-[#fafaf9] p-4 flex items-start gap-3">
        <Award size={18} className="text-[#F97316] flex-shrink-0 mt-0.5" />
        <div>
  ...
  return (
    <div className="border border-[#F97316]/30 bg-[#f5f0e8]/50 p-5">
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <div>
          ...
          <p className="text-lg font-bold text-[#F97316]">{data.points} pts</p>
        </div>
        <div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="w-24 px-3 py-2 text-sm border border-[#e5e7eb] focus:border-[#F97316] focus:outline-none"
              />
              <span className="text-sm text-[#6b7280]">points</span>
              <span className="text-sm text-[#F97316] font-semibold ml-auto">
            ...
            <button
              ...
              className="w-full mt-2 bg-[#1a1a1a] text-white py-2.5 text-sm font-semibold hover:bg-[#F97316] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
