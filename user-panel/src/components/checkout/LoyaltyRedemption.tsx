...
export function LoyaltyRedemption({ subtotal, onRedeem, currentPoints }: Props) {
  ...
  if (data.points === 0) {
    return (
      <div className="border border-[#e5e7eb] bg-[#fafaf9] p-4 flex items-start gap-3">
        <Award size={18} className="text-[#c9a96e] flex-shrink-0 mt-0.5" />
        <div>
  ...
  return (
    <div className="border border-[#c9a96e]/30 bg-[#f5f0e8]/50 p-5">
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <div>
          ...
          <p className="text-lg font-bold text-[#c9a96e]">{data.points} pts</p>
        </div>
        <div>
        ...
        <>
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-[#c9a96e] font-semibold ml-auto">
            ...
            <button
              ...
              className="w-full mt-2 bg-[#1a1a1a] text-white py-2.5 text-sm font-semibold hover:bg-[#c9a96e] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
