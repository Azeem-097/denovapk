...
export function BirthdayBadge({ subtotal, onDiscountApplied }: Props) {
  ...
  return (
    <div className="border-2 border-[#E10600] bg-gradient-to-r from-[#f5f0e8] to-[#f5f0e8]/50 p-4 relative overflow-hidden">
      <div className="absolute top-0 right-0 opacity-10">
        <Cake size={100} className="text-[#E10600] -mt-2 -mr-2" />
      </div>
      ...
      <div className="relative flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          {meetsMin ? (
            <p className="text-sm text-[#E10600] font-semibold mt-1">
              Your{" "}
