  ...
  return (
    <div className="space-y-2">
      ...
      {data.activePromo === "birthday" && (
        <div className="rounded-md bg-[#f5f0e8] border border-[#c9a96e]/30 p-3">
      ...
      {data.loyalty.eligible && !data.loyalty.blocked && (
        <div className="rounded-md bg-[#fafaf9] border border-[#e5e7eb] p-3">
          <div className="flex items-center gap-2 mb-2.5">
            ...
            <span className="ml-auto text-xs font-medium text-[#c9a96e]">
      ...
      {data.loyalty.blocked && data.loyalty.points > 0 && (
        <div className="rounded-md bg-[#fafaf9] border border-[#e5e7eb] p-3 flex items-start gap-2">
          ...
          <p className="text-xs text-[#6b7280]">
            You have <span className="font-semibold text-[#c9a96e]">{data.loyalty.points} loyalty points</span> but they cannot be used on this order because a {data.loyalty.blockedBy === "birthday" ? "birthday" : "first order"} discount is applied.
          </p>
        </div>
      )}
    </div>
