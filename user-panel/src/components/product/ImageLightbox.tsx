    ...
    >
      ...
      {images.length > 1 && (
        <div className="absolute top-5 left-5 sm:top-7 sm:left-7 z-20 text-[#1a1a1a]/70 text-sm font-medium tracking-wide tabular-nums">
          {currentIdx + 1} <span className="text-[#F97316] mx-1">/</span> {images.length}
        </div>
      )}
      ...
      >
        ...
        {images.length > 1 && (
          <button
            ...
            className="absolute left-3 sm:left-8 top-1/2 -translate-y-1/2 z-10 w-11 h-11 sm:w-12 sm:h-12 flex items-center justify-center rounded-full text-[#1a1a1a] border border-[#e5e7eb] bg-white hover:bg-[#f5f0e8] hover:border-[#F97316] shadow-sm transition-all duration-200 active:scale-95"
        ...
        {images.length > 1 && (
          <button
            ...
            className="absolute right-3 sm:right-8 top-1/2 -translate-y-1/2 z-10 w-11 h-11 sm:w-12 sm:h-12 flex items-center justify-center rounded-full text-[#1a1a1a] border border-[#e5e7eb] bg-white hover:bg-[#f5f0e8] hover:border-[#F97316] shadow-sm transition-all duration-200 active:scale-95"
          ...
          {images.map((img, i) => (
            <button
              ...
              className={cn(
                ...
                i === currentIdx
                  ? "ring-2 ring-[#F97316] ring-offset-2 ring-offset-white opacity-100"
