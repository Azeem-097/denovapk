  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={cn(
            "absolute top-3 left-3 w-4 h-4 border-t border-l border-[#3b5f8f] transition-all duration-500 pointer-events-none",
            isHovered ? "opacity-100 scale-100" : "opacity-0 scale-75"
          )}
        />
        <div
          className={cn(
            "absolute bottom-3 right-3 w-4 h-4 border-b border-r border-[#3b5f8f] transition-all duration-500 delay-100 pointer-events-none",
            isHovered ? "opacity-100 scale-100" : "opacity-0 scale-75"
          )}
        />
        ...
        >
          <Heart
            ...
            className={cn(
              ...
              mounted && isInWishlist ? "text-[#3b5f8f] fill-[#3b5f8f] scale-110" : "text-[#1a1a1a]"
            )}
          />
        </button>
      ...
      <div className="px-0.5 space-y-1.5">
        ...
        <Link href={`/products/${product.slug}`}>
          <h3 className="text-xs sm:text-[13px] font-medium tracking-[0.08em] uppercase text-[#1a1a1a] hover:text-[#3b5f8f] transition-colors duration-300 leading-snug line-clamp-1">
            {product.name}
          </h3>
        </Link>
